...
{
public:
	void init( MatrixXd &_X, VectorXd &_Y, double _lambda = 1.0, int _warmup_iterations = 100, int _iterations = 1000, int _minibatch = 100, double _step_size = 0.01, int _num_step = 100, bool _normalization =true, bool _standarization=true, int _samples = 1000, string _path="", double _path_lenght = 0.0);
